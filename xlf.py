...
# def transact_xlf_constituents(gs, ms, wfc, xlf, direction):
...
# def sell_at_xlf(gs, ms, wfc, xlf):
#     buy_xlf_constituents = transact_xlf_constituents(gs, ms, wfc, "BUY")
...
# def buy_at_xlf(gs, ms, wfc, xlf):
#     sell_xlf_constituents = transact_xlf_constituents(gs, ms, wfc, "SELL")
#     return [
...
# def xlf_action(gs, ms, wfc, xlf):
#     if get_xlf_value(gs, ms, wfc, "SELL") + CONVERSION_COST + BUFFER_SIZE < (xlf["BUY"][0][0] * UNIT_SIZE):
#         return sell_at_xlf(gs, ms, wfc, xlf)
#     elif get_xlf_value(gs, ms, wfc, "BUY") > (xlf["SELL"][0][0] * UNIT_SIZE + CONVERSION_COST + BUFFER_SIZE):
#         return buy_at_xlf(gs, ms, wfc, xlf)